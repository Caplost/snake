# Test Specification - Snake CLI Game v2

## Overview

This test specification covers the v2 implementation of the Snake CLI game, which adds proper ASCII border rendering to the game grid. The primary change from v1 is the border character update from `#` to proper ASCII border with corners `+`, horizontal edges `-`, and vertical edges `|`.
...
| Rapid key presses | Input handled in separate goroutine |
