# live-verdict-screenshot-check - Test Specification v1
...
| Synchronous test execution | Prevents session stale from interrupting tests | Verified via `go test` blocking behavior |
