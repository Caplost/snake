...
| `.cast` file generated | ✅ PASS | `20260417-191651-snake-gameplay.cast` (1147 bytes) |
...
Recording snake game session to .../snake/screenshots/20260417-191651-snake-gameplay.cast
Recording for 5 seconds (or until game exits)...
::: TTY not available, recording in headless mode
::: asciinema session started
::: Recording to .../snake/screenshots/20260417-191651-snake-gameplay.cast
::: asciinema session ended
SUCCESS: Recording saved to .../20260417-191651-snake-gameplay.cast (1147 bytes, asciinema format)
Exit code: 0
```
...
Most recent tracked .cast file: `20260417-191338-snake-gameplay.cast`
Fresh run generated: `20260417-191651-snake-gameplay.cast` (not yet committed - expected)
...
Latest screenshot from fresh run:
```
.woali/fp-89b990d2-cdb8-489b-97fe-7cdd01fe5e97/screenshots-v5/20260417-191651-snake-gameplay.cast
```
